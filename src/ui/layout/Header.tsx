...
export function Header () {
  ...
  const [mostrarInfoLogin, setMostrarInfoLogin] = useState<boolean>()
  ...
  useEffect(() => {
    ...
    setMostrarInfoLogin(operario.name !== '' && lote !== '' && tipoAplicacion.name !== '')
      ...
      <>
        ...
        <header className='w-full fixed h-[64px] bg-[#1C2E3D] z-10 pl-[112px] pr-[96px] flex items-center justify-between'>
          ...
          <div className='flex gap-2 items-center text-white'>
            ...
            {mostrarInfoLogin && <button ref={buttonRef} className='ml-10' onClick={handleInfoLoginClick}>
