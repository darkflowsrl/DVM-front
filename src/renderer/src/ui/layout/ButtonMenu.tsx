...
export function ButtonMenu(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const closeClick = (e: Event) => {
      ...
      // @ts-expect-error
      if (e.target && buttonRef.current?.contains(e.target)) {
        return
      }
  ...
  return (
    <button
      ...
      onClick={() => {
        if (habilitar) toggleOpenedState('menu-lateral')
      }}
    >
      <svg
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1179_579" />
            <feBlend
              mode="normal"
              in="SourceGraphic"
